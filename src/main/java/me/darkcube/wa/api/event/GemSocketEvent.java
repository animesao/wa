...
/**
 * Вызывается при вставке самоцвета в артефакт.
 */
public class GemSocketEvent extends PlayerEvent implements Cancellable {
    ...
    public GemSocketEvent(@NotNull Player player, @NotNull ItemStack artifactItem, @NotNull Gem gem, int slotIndex) {
        super(player);
